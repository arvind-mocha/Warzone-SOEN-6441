...
public class HumanStrategyTest {
    ...
    public void setUp() {
        ...
        country = new Country("Country1", null, 10);  // Country with 10 armies
    ...
    public void testCreateOrder() {
        ...
        // Check that the order is null or empty (since the human player needs to input the order manually)
    ...
    public void testGenerateCardOrder() {
        ...
        // Check that the card order is empty string ("") since human player will decide the card order manually
    ...
    public void testGetNeighbourWithNoValidNeighbours() {
        ...
        country.setNeighbourCountryIds(new ArrayList<>());  // No neighbors
        ...
        // Assert that no neighbor is found, so it should return null
