...
public class CommonErrorMessages {
    ...
    public static final String CONUTRYLESS_CONTINENT = "No countries are present in the continent";
    ...
    public static final String CONTINENT_ALREADY_EXISTS = "Continent %s exists already";
