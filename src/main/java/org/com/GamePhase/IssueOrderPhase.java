...
public class IssueOrderPhase implements Phase {
    ...
    public ArrayList<String> getValidCommands() {
        return new ArrayList<>(Arrays.asList(Commands.DEPLOY_ARMY_COMMAND.getName(), Commands.ADVANCE_ARMY_COMMAND.getName(), Commands.COMMIT.getName(), Commands.BLOCKADE_COMMAND.getName(), Commands.AIRLIFT_COMMAND.getName() ,Commands.NEGOTIATE_COMMAND.getName(), Commands.BOMB_COMMAND.getName()));
    }
